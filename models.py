...
class Decoder(nn.Module):
    def __init__(self, H):
        ...
        self.resnet = get_1x1(H.width, H.output_channels)
        self.gain = nn.Parameter(torch.ones(1, H.output_channels, 1, 1))
        self.bias = nn.Parameter(torch.zeros(1, H.output_channels, 1, 1))
