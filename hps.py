...
tinyimagenet64.dec_blocks = "1x2,4m1,4x3,8m4,8x7,16m8,16x16,32m16,32x32,64m32,64x16"
...
def add_imle_arguments(parser):
    ...
    parser.add_argument('--residual_ratio', type=float, default=-5.0)
