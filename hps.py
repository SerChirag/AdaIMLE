...
imagenet_folder.dec_blocks = "1x1,4m1,4x2,8m4,8x4,16m8,16x4,32m16,32x7"
...
imagenet_folder.convnext_expansion = 4
...
def add_imle_arguments(parser):
    ...
    parser.add_argument('--lr_eta_min_frac', type=float, default=0.1)  # eta_min for cosine scheduler as fraction of lr
    ...
    parser.add_argument('--ae_batch', type=int, default=32)  # batch size for autoencoder encode/decode passes
    ...
    parser.add_argument('--latent_loss_coef', type=float, default=1.0,
                         help="Weight on the latent-space reconstruction loss (--loss_type), the term "
                              "that --lpips_coef is traded off against. Pass 0 to train on the "
                              "decoder-space LPIPS term alone.")
