...
stl10.lr = 0.0002
stl10.wd = 0.01
stl10.dec_blocks = "1x1,4m1,4x8,8m4,8x16,16m8,16x17,32m16,32x24"
...
stl10.multi_res_scales = '8,12,16,24,28'
...
def add_imle_arguments(parser):
    ...
    parser.add_argument('--latent_dim', type=int, default=3072)  # latent code dimension
    ...
    parser.add_argument('--use_interpolate_latents', default=True, type=lambda x: bool(strtobool(x)))  # whether to use ema
