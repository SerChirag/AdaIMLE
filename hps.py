...
def add_imle_arguments(parser):
    ...
    parser.add_argument('--reverse_loss_weight', type=float, default=0.2) # downsample factor for l2 search
    parser.add_argument('--reverse_force_factor', type=float, default=0.5) # downsample factor for l2 search
